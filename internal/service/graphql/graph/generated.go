...
func (ec *executionContext) childFields_Alloy(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "branch":
...
func (ec *executionContext) _Component_health(ctx context.Context, field graphql.CollectedField, obj *model.Component) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v model.Health) graphql.Marshaler {
			return ec.marshalNHealth2githubᚗcomᚋgrafanaᚋalloyᚋinternalᚋserviceᚋgraphqlᚋgraphᚋmodelᚐHealth(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_alloy(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_alloy(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Query().Alloy(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v model.Alloy) graphql.Marshaler {
			return ec.marshalNAlloy2githubᚗcomᚋgrafanaᚋalloyᚋinternalᚋserviceᚋgraphqlᚋgraphᚋmodelᚐAlloy(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) fieldContext_Query_alloy(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		IsResolver: true,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_Alloy(ctx, field)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) _Query_component(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_component(ctx, field)
		},
		func(ctx context.Context) (any, error) {
