...
// ServerHandler.
func NewDecoupledCloudwatchExporter(name string, logger *slog.Logger, conf yaceModel.JobsConfig, scrapeInterval time.Duration, fipsEnabled, labelsSnakeCase, debug bool) (*asyncExporter, error) {
