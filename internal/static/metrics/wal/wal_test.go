	...
	return seriesList{
		{
			...
			exemplars: []exemplar.Exemplar{
				{Labels: labels.FromStrings("foobar", "barfoo"), Value: 10.0, Ts: int64(1), HasTs: true},
				{Labels: labels.FromStrings("lorem", "ipsum"), Value: 100.0, Ts: int64(10), HasTs: true},
			},
		},
		...
		// the -1.
		{
			...
			exemplars: []exemplar.Exemplar{
				{Labels: labels.FromStrings("foobar", "barfoo"), Value: 10.0, Ts: int64(2), HasTs: true},
				{Labels: labels.FromStrings("lorem", "ipsum"), Value: 100.0, Ts: int64(20), HasTs: true},
			},
		},
		{
			...
			exemplars: []exemplar.Exemplar{
				{Labels: labels.FromStrings("foobar", "barfoo"), Value: 10.0, Ts: int64(3), HasTs: true},
				{Labels: labels.FromStrings("lorem", "ipsum"), Value: 100.0, Ts: int64(30), HasTs: true},
			},
		},
		{
			name:    "integer NHCB",
