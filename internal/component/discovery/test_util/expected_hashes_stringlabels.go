...
// These values are specific to how Prometheus stringlabels implementation hashes labels.
func ExpectedHashes() TestHashes {
	return TestHashes{
		...
		GroupHashHipHop:          1496074619635556473, // hash of {"hip": "hop"}
		GroupHashKungFoo:         8772635816824701088, // hash of {"kung": "foo"}
	}
}
