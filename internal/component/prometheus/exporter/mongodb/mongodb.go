...
func (a *Arguments) SetToDefault() {
	// Set DirectConnect to true by default, all others to false to match
	// the minimal output expectation of some converter tests.
	a.DirectConnect = true

	a.CompatibleMode = false
	a.CollectAll = false
