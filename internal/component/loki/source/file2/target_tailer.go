...
var _ source.Target = (*tailerTarget)(nil)

func (t *tailerTarget) Run(ctx context.Context) {
	backoff := backoff.New(
		ctx,
		backoff.Config{
...
func (t *tailerTarget) Equals(other runner.Task) bool {
	otherTask := other.(*tailerTarget)
...
func (t *tailerTarget) Hash() uint64 {
	return t.hash
}
...
func (t *tailerTarget) initRun() (loki.EntryHandler, error) {
	...
	labels := t.labels.Merge(model.LabelSet{filenameLabel: model.LabelValue(t.path)})
	handler := loki.AddLabelsMiddleware(labels).Wrap(loki.NewEntryHandler(t.receiver.Chan(), func() {}))
...
func (t *tailerTarget) updatePosition(posquit chan struct{}) {
...
func (t *tailerTarget) readLines(handler loki.EntryHandler, done chan struct{}) {
...
func (t *tailerTarget) markPositionAndSize() error {
...
func (t *tailerTarget) stop(done chan struct{}) {
...
func (t *tailerTarget) IsRunning() bool {
	return t.running.Load()
}

func (t *tailerTarget) convertToUTF8(text string) (string, error) {
...
func (t *tailerTarget) cleanupMetrics() {
