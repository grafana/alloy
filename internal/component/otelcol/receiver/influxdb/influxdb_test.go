...
func TestWriteLineProtocol_Alloy(t *testing.T) {
	...
	receiver, outerErr := influxdbreceiver.NewFactory().CreateMetrics(context.Background(), receivertest.NewNopSettings(component.MustNewType("influxdb")), config, nextConsumer)
