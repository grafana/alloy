...
func TestArguments_UnmarshalAlloy(t *testing.T) {
	...
	require.False(t, otelArgs.Metrics.VcenterHostNetworkPacketCount.Enabled)
	require.True(t, otelArgs.Metrics.VcenterHostNetworkPacketRate.Enabled)
	require.False(t, otelArgs.Metrics.VcenterHostNetworkPacketErrors.Enabled)
	...
	require.False(t, otelArgs.Metrics.VcenterVMNetworkPacketCount.Enabled)
