...
// NewDefaultComponentRegistry creates a new [Registry] which gets
// components registered to github.com/grafana/alloy/internal/component.
func NewDefaultComponentRegistry(minStability featuregate.Stability, enableCommunityComps bool) Registry {
...
// Get retrieves a component using [.Get]. It returns an error if the component does not exist,
