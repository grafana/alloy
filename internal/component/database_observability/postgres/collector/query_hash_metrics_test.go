...
func TestQueryHashMetricsCollector_ExposesRegistryAsJoinMetric(t *testing.T) {
	...
	col := NewQueryHashMetricsCollector(qhr)
...
database_observability_query_hash_info{datname="books_store",query_fingerprint="fpAAAA",queryid="12345"} 1
database_observability_query_hash_info{datname="library",query_fingerprint="fpBBBB",queryid="67890"} 1
`
