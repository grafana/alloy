...
func TestIndexStats(t *testing.T) {
	...
	# HELP database_observability_pg_index_size_bytes Total disk space used by this index, in bytes, labeled with whether it backs a primary key or unique constraint, or is partial
	# TYPE database_observability_pg_index_size_bytes gauge
	database_observability_pg_index_size_bytes{datname="books_store",indexrelname="books_pkey",is_partial="false",is_primary="true",is_unique="true",relname="books",schemaname="public"} 65536
	database_observability_pg_index_size_bytes{datname="books_store",indexrelname="idx_books_title",is_partial="true",is_primary="false",is_unique="false",relname="books",schemaname="public"} 32768
`
