...
func (c *Component) Update(args component.Arguments) error {
	...
	for _, t := range c.args.Targets {
		...
		if relabel.ProcessBuilder(builder, database_observability.GetRelabelingRules(serverUUID, cp)...) {
	...
	if err := c.startCollectors(serverUUID, engineVersion, parsedEngineVersion, cp); err != nil {
