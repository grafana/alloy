...
func Test_enableOrDisableCollectors(t *testing.T) {
	...
	t.Run("enable collectors", func(t *testing.T) {
		...
		data_source_name = ""
		forward_to = []
		enable_collectors = ["query_tables", "schema_table", "query_sample", "setup_consumers", "locks"]
	`
	...
	t.Run("enable collectors takes precedence over disable collectors", func(t *testing.T) {
		...
		data_source_name = ""
		forward_to = []
		disable_collectors = ["query_tables", "schema_table", "query_sample", "setup_consumers", "locks"]
		enable_collectors = ["query_tables", "schema_table", "query_sample", "setup_consumers", "locks"]
	`
	...
	t.Run("enabling one and disabling others", func(t *testing.T) {
		...
		data_source_name = ""
		forward_to = []
		disable_collectors = ["schema_table", "query_sample", "setup_consumers", "locks"]
