...
// https://github.com/prometheus-operator/prometheus-operator/blob/v0.86.1/pkg/alertmanager/types.go
// Some fields were exported by renaming them to uppercase, and some functions were added.
// TODO: Look into importing it from the upstream repo?
