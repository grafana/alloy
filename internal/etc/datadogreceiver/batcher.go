...
func parseSeriesProperties(name string, metricType string, tags []string, host string, version string) Dimensions {
	resourceAttrs, scopeAttrs, dpAttrs := tagsToAttributes(tags, host)
	return Dimensions{
		name:          name,
