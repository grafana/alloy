...
dist/alloy-linux-amd64: generate-ui dist/pyroscope-dependencies
...
dist/alloy-linux-arm64: generate-ui dist/pyroscope-dependencies
	$(PACKAGING_VARS) ALLOY_BINARY=$@ "$(MAKE)" -f $(PARENT_MAKEFILE) alloy
...
dist/alloy-boringcrypto-linux-amd64: generate-ui dist/pyroscope-dependencies
	$(PACKAGING_VARS) ALLOY_BINARY=$@ "$(MAKE)" -f $(PARENT_MAKEFILE) alloy
...
dist/alloy-boringcrypto-linux-arm64: generate-ui dist/pyroscope-dependencies
	$(PACKAGING_VARS) ALLOY_BINARY=$@ "$(MAKE)" -f $(PARENT_MAKEFILE) alloy
