...
dist/alloy-linux-amd64: GO_TAGS += netgo embedalloyui promtail_journal_enabled slicelabels
...
dist/alloy-windows-amd64.exe: GO_TAGS += embedalloyui slicelabels
...
# TODO(rfratto): add netgo back to Windows builds if a version of Go is
# released which natively supports resolving DNS short names on Windows.
dist/alloy-freebsd-amd64: GO_TAGS += netgo embedalloyui slicelabels
...
dist/alloy-boringcrypto-linux-amd64: GO_TAGS      += netgo embedalloyui promtail_journal_enabled slicelabels
...
dist/alloy-boringcrypto-linux-arm64: GO_TAGS      += netgo embedalloyui promtail_journal_enabled slicelabels
...
dist.temp/alloy-service-windows-amd64.exe: GO_TAGS += embedalloyui slicelabels
