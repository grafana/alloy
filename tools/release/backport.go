...
func backportCommand() *cobra.Command {
	var flags backportFlags

	cmd := &cobra.Command{
		Use:   "backport",
		Short: "Cherry-pick a merged PR to a release branch and open a backport PR",
		RunE: func(cmd *cobra.Command, args []string) error {
			return runBackport(cmd.Context(), flags)
		},
	}
...
func runBackport(ctx context.Context, flags backportFlags) (retErr error) {
