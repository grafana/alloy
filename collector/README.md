...
`make alloy` runs the code generation steps described above automatically before building. Generation is skipped in CI and when `SKIP_CODE_GENERATION=1` is set.
