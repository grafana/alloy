...
BEYLA_CONFIG_GEN     := $(BEYLA_CONFIG_DIR)/config_gen.go
...
$(BEYLA_CONFIG_GEN): $(BEYLA_SCHEMA_STAMP) $(BEYLA_SCHEMA_DIR)/mappings.json
	@echo "  Regenerating config_gen.go..."
	@cd $(BEYLA_CONFIG_DIR) && env -u GOOS -u GOARCH -u GOARM go generate .
