...
require (
	...
	github.com/grafana/loki/v3 v3.6.0 // main branch (commit 053429db212405966051e8410ccf786db26065f1) - replace once there is a release that upgrades Loki's Prometheus.
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/loadbalancingexporter v0.140.1 // bug with v139 https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/43950
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/prometheusexporter v0.140.1 // TODO: Upgrade this when we can use a new version of otlptranslator
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.140.1 // TODO: Upgrade this when we can use a new version of otlptranslator
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding v0.140.1 // indirect; indirect)
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.140.1 // indirect
...
replace go.opentelemetry.io/ebpf-profiler => /tmp/ebpf-profiler-fix
