...
// TODO: Fork to update Prometheus to v0.309.1 while keeping OTel Collector at v0.143.0. Remove when OTel Collector is upgraded to v0.144.0+, which includes this change upstream.
