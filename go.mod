...
require (
	...
	github.com/grafana/loki/pkg/push v0.0.0-20240617182007-6c33561108ad // k201 branch
	github.com/grafana/loki/v3 v3.0.0-20240617182007-6c33561108ad // k201 branch
