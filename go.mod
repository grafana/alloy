...
// Replace yaml.v2 with fork (synced from collector/builder-config.yaml)
replace gopkg.in/yaml.v2 => github.com/rfratto/go-yaml v0.0.0-20211119180816-77389c3526dc

// Replace directives from Loki — Azure SDK (synced from collector/builder-config.yaml)
replace github.com/Azure/azure-sdk-for-go => github.com/Azure/azure-sdk-for-go v68.0.0+incompatible

// Replace directives from Loki — Azure storage blob fork (synced from collector/builder-config.yaml)
...
// Use fork of gocql that has gokit logs and Prometheus metrics (synced from collector/builder-config.yaml)
replace github.com/gocql/gocql => github.com/grafana/gocql v0.0.0-20200605141915-ba5dc39ece85

// Insist on the optimised version of grafana/regexp (synced from collector/builder-config.yaml)
replace github.com/grafana/regexp => github.com/grafana/regexp v0.0.0-20240518133315-a468a5bfb3bc

// Replace memberlist with Grafana fork which includes unmerged upstream fixes (synced from collector/builder-config.yaml)
replace github.com/hashicorp/memberlist => github.com/grafana/memberlist v0.3.1-0.20220714140823-09ffed8adbbe

// Use forked syslog implementation by leodido for continued support (synced from collector/builder-config.yaml)
replace github.com/influxdata/go-syslog/v3 => github.com/leodido/go-syslog/v4 v4.3.0

// Replace thanos-io/objstore with Grafana fork (synced from collector/builder-config.yaml)
replace github.com/thanos-io/objstore => github.com/grafana/objstore v0.0.0-20250210100727-533688b5600d

// TODO - remove forks when changes are merged upstream — non-singleton cadvisor Fork branch: https://github.com/grafana/cadvisor/tree/grafana-v0.54.1-noglobals (synced from collector/builder-config.yaml)
replace github.com/google/cadvisor => github.com/grafana/cadvisor v0.0.0-20260204200106-865a22723970

// TODO - this tracks exporter-package-v0.19.1 branch of grafana fork; remove once all patches are merged upstream (synced from collector/builder-config.yaml)
...
// TODO - this tracks exporter-package-v0.19.0 branch of grafana fork; remove once all patches are merged upstream (synced from collector/builder-config.yaml)
replace github.com/prometheus/mysqld_exporter => github.com/grafana/mysqld_exporter v0.0.0-20260319134024-e0461af8db16

// TODO: replace node_exporter with custom fork for multi usage. https://github.com/prometheus/node_exporter/pull/2812 (synced from collector/builder-config.yaml)
...
// Use Grafana fork of smimesign (synced from collector/builder-config.yaml)
replace github.com/github/smimesign => github.com/grafana/smimesign v0.2.1-0.20220408144937-2a5adf3481d3

// Replace OpenTelemetry OBI with Grafana fork (synced from collector/builder-config.yaml)
replace go.opentelemetry.io/obi => github.com/grafana/opentelemetry-ebpf-instrumentation v1.18.4

// Replace OpenTelemetry eBPF profiler with Grafana fork (synced from collector/builder-config.yaml)
...
// Update openshift/client-go to version compatible with structured-merge-diff v6 (synced from collector/builder-config.yaml)
replace github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20251015124057-db0dee36e235

// Do not remove until bug in walqueue backwards compatibility is resolved: https://github.com/deneonet/benc/issues/13 (synced from collector/builder-config.yaml)
replace github.com/deneonet/benc => github.com/deneonet/benc v1.1.7

// Pin runc to v1.2.8 for compatibility with cadvisor requiring libcontainer/cgroups packages (synced from collector/builder-config.yaml)
replace github.com/opencontainers/runc => github.com/opencontainers/runc v1.2.8

// Replace controller-runtime with pinned version (synced from collector/builder-config.yaml)
replace sigs.k8s.io/controller-runtime => sigs.k8s.io/controller-runtime v0.20.4

// Fork to grafana repo to address issue with freebsd build tags. This can be removed once https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/42645 is fixed (synced from collector/builder-config.yaml)
...
// Fix sent_batch_duration_seconds measuring before the request was sent. Fork branch: https://github.com/grafana/prometheus/tree/fix-sent-batch-duration-c7bc56cf6c8f Remove when https://github.com/prometheus/prometheus/pull/18214 is merged and Prometheus is upgraded. (synced from collector/builder-config.yaml)
replace github.com/prometheus/prometheus => github.com/grafana/prometheus v1.8.2-0.20260313093229-87200e297b57

// Fork hashicorp/vault to replace obsolete aws-sdk-go with aws-sdk-go-v2 (see: https://github.com/grafana/alloy/issues/2936). Fork branch: https://github.com/DataDog/vault/tree/master. Remove when https://github.com/hashicorp/vault/issues/29884 is resolved. (synced from collector/builder-config.yaml)
replace github.com/hashicorp/vault/api/auth/aws => github.com/DataDog/vault/api/auth/aws v0.0.0-20250716193101-44fb30472101

// Work around DataDog split module ambiguity for pkg/util/system/socket by pinning util/system to the same rc stream used by current datadogexporter deps. Remove when https://github.com/open-telemetry/opentelemetry-collector-contrib/pull/45955 (and follow-up releases) fully align DataDog modules. (synced from collector/builder-config.yaml)
