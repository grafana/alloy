...
// Pin githubreceiver to v0.142.0 to avoid v0.144.0 API breaking changes
replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/githubreceiver => github.com/open-telemetry/opentelemetry-collector-contrib/receiver/githubreceiver v0.142.0

// Pin test dependencies pulled by githubreceiver to v0.142.0
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest => github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.142.0

replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil => github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.142.0

// Pin confighttp to v0.142.0 to match existing code
replace go.opentelemetry.io/collector/config/confighttp => go.opentelemetry.io/collector/config/confighttp v0.142.0
