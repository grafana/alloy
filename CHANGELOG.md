...
## [1.15.0](https://github.com/grafana/alloy/compare/v1.14.0...v1.15.0) (2026-03-09)
...
* Add `prometheus.echo` component for local metrics inspection ([#4105](https://github.com/grafana/alloy/issues/4105)) ([7f6d0d2](https://github.com/grafana/alloy/commit/7f6d0d248f7f6da929537672f41c7c020b4326ec))
...
* add delay option to CW exporter ([#4936](https://github.com/grafana/alloy/issues/4936)) ([1ab7f12](https://github.com/grafana/alloy/commit/1ab7f127db7ae15e34aaa40ad8ffe8d378d3fe96))
* Add Handling for OCB In YAML Dependency File ([#5065](https://github.com/grafana/alloy/issues/5065)) ([d85471c](https://github.com/grafana/alloy/commit/d85471cd4410a15a38d54bdbaa3f50b384f0f945))
...
* Add lazy mode argument to pyroscope.ebpf ([#4824](https://github.com/grafana/alloy/issues/4824)) ([2eb281c](https://github.com/grafana/alloy/commit/2eb281c9ae2476c533c3078b761c8016cd5c3790))
...
* add metadata support to `prometheus.remote_write` component, but only if Remote Write v2 has been configured. In order for `prometheus.remote_write` to receive metadata, `prometheus.scrape` must be configured with `honor_metadata = true`. ([74d424b](https://github.com/grafana/alloy/commit/74d424bd6288829f1ddd627fdb55ac500eb3a4f8))
...
* **alloy:** add cloudflare receiver ([#4781](https://github.com/grafana/alloy/issues/4781)) ([5277abd](https://github.com/grafana/alloy/commit/5277abd59a3b9301d6e7820a57d0f11687bed104))
...
* **component/otelcol/connector:** add support for logs to metrics connectors ([#4550](https://github.com/grafana/alloy/issues/4550)) ([ec0f6a6](https://github.com/grafana/alloy/commit/ec0f6a6c961e973e3f01d7fc9fe4393241840aaa))
...
* **faro:** add per-app rate limiting for receiver ([#4688](https://github.com/grafana/alloy/issues/4688)) ([211f426](https://github.com/grafana/alloy/commit/211f4262e647fa48910424b5c5fb2e42d946e26b))
...
* **loki.process:** add regex field to structured_metadata stage ([#4629](https://github.com/grafana/alloy/issues/4629)) ([115db41](https://github.com/grafana/alloy/commit/115db413fb7f18d17b365e57c59e8b5942ced149))
...
* **otelcol.connector:** adding connector count ([#4913](https://github.com/grafana/alloy/issues/4913)) ([b1cb806](https://github.com/grafana/alloy/commit/b1cb806a2d9cc53c778fe8c8ccd79d7517b95965))
...
* **otelcol.exporter.prometheus:** Add `honor_metadata` config argument ([#5431](https://github.com/grafana/alloy/issues/5431)) ([19da4be](https://github.com/grafana/alloy/commit/19da4be0feff8db0ec90f168fa5182cb31cdf2ac))
...
* **otelcol.receiver:** add awss3 receiver ([#4928](https://github.com/grafana/alloy/issues/4928)) ([bc3885b](https://github.com/grafana/alloy/commit/bc3885b3db674eebc5b2c75b1bd758d451996b46))
* **otelcol:** add support for htpasswd file authentication ([#3916](https://github.com/grafana/alloy/issues/3916)) ([c564d09](https://github.com/grafana/alloy/commit/c564d09fdbecae8d631ffac83f717af3090b39d3))
...
* pyroscope.enrich component ([#4797](https://github.com/grafana/alloy/issues/4797)) ([cc7448f](https://github.com/grafana/alloy/commit/cc7448f00a1f9a686704c6a6f8180baf05a906fb))
...
* support DNS SD URLs ([#5034](https://github.com/grafana/alloy/issues/5034)) ([d2fda91](https://github.com/grafana/alloy/commit/d2fda91f42967e8281f6b8e3c948a4acf11542da))
...
* update converter to use file_match block ([#4791](https://github.com/grafana/alloy/issues/4791)) ([a42f386](https://github.com/grafana/alloy/commit/a42f3861d6418edfe5bec5b68824f7e503413d63))
...
* add StoreBuilder to mimir.alerts.kubernetes eventProcessor ([#5010](https://github.com/grafana/alloy/issues/5010)) ([9052910](https://github.com/grafana/alloy/commit/9052910818a5bbfa707154dcbbf350a6091e3225))
...
* Address Remaining Stringlabels Issues Before Enabling ([#4810](https://github.com/grafana/alloy/issues/4810)) ([10b5d99](https://github.com/grafana/alloy/commit/10b5d99a052571aad02a494f61e05300dde29f2c))
...
* delegate check of Enabled check in our slog wrapper  ([#4812](https://github.com/grafana/alloy/issues/4812)) ([0d418e5](https://github.com/grafana/alloy/commit/0d418e56b624ae0a31585fc1d931217ef83dd5f9))
...
* **deps:** update module golang.org/x/crypto to v0.45.0 [security] ([#4837](https://github.com/grafana/alloy/issues/4837)) ([3aea96e](https://github.com/grafana/alloy/commit/3aea96ed53dbf6004244722dca29e4d7161e4958))
...
* faster target scheduling for loki.source.docker ([#5026](https://github.com/grafana/alloy/issues/5026)) ([9504766](https://github.com/grafana/alloy/commit/95047662f388549495139b3a9744eb8c464d5d5c))
* **gcp_exporter:** Preserve colons in extra_fiilters filter expressions ([#5018](https://github.com/grafana/alloy/issues/5018)) ([398365d](https://github.com/grafana/alloy/commit/398365d56468f5aba2aecce4c46cdb4edf50f41e))
...
* Improvements to SET search_path for postgres explain plans ([#5422](https://github.com/grafana/alloy/issues/5422)) ([0044e03](https://github.com/grafana/alloy/commit/0044e0365710c7394c994c57690a585caab22440))
...
* **loki.process:** Implement encoding.TextMarshaler and encoding.TextUnmarshaler for TruncateSourceType ([#5419](https://github.com/grafana/alloy/issues/5419)) ([8f6c1b3](https://github.com/grafana/alloy/commit/8f6c1b3b050c0933b45c3363dd3a510696270ae2))
...
* **loki.process:** Prevent panic when stage config is invalid ([#5456](https://github.com/grafana/alloy/issues/5456)) ([bd2eac1](https://github.com/grafana/alloy/commit/bd2eac140943a6beab1f1145666a2ad517538f6f))
...
* **loki.source.file:** Update `tail_from_end` to properly handle file encoding ([#5429](https://github.com/grafana/alloy/issues/5429)) ([807ff00](https://github.com/grafana/alloy/commit/807ff00f67f03d91464124d6d518425ab6b27ca6))
...
* **loki.source.podlogs:** set validation scheme ([#4931](https://github.com/grafana/alloy/issues/4931)) ([33a7a40](https://github.com/grafana/alloy/commit/33a7a40d7b123aab9b8f42a91c5530ebeed6a947))
* Make query sample text nullable in MySQL query details collector for database_observability ([#5425](https://github.com/grafana/alloy/issues/5425)) ([02ecc81](https://github.com/grafana/alloy/commit/02ecc81d23d2146d253125aa9701035beaae1d3f))
...
* no longer drop request if stream is dropped in loki.source.api ([#4834](https://github.com/grafana/alloy/issues/4834)) ([74653ac](https://github.com/grafana/alloy/commit/74653acb0245e865df3eda853861dd54234b863c))
...
* **pyroscope.ebpf:** Use meter noop in otel-ebpf-profiler ([#4920](https://github.com/grafana/alloy/issues/4920)) ([671123c](https://github.com/grafana/alloy/commit/671123ca2eb2e145053ef7f5e89d0c5f0b6b919d))
...
* Revert doublestar v4 update ([#5434](https://github.com/grafana/alloy/issues/5434)) ([0925795](https://github.com/grafana/alloy/commit/09257958313b90b370048c25efecf70da61463a9))
...
* **scheduling:** Shutdown runnables with a timeout before starting new ones ([#5401](https://github.com/grafana/alloy/issues/5401)) ([0fb959d](https://github.com/grafana/alloy/commit/0fb959deeee80632633bb1d8e3b5134e320c8bee))
...
* update beyla to 2.7.10 ([615bb61](https://github.com/grafana/alloy/commit/615bb6137fd430b0fb73b26893fae717e412de38))
