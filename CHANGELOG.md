...
## [1.20.0](https://github.com/grafana/alloy/compare/v1.19.0...v1.20.0) (2026-09-22)


### ⚠ BREAKING CHANGES

* **otelcol.processor.transform:** `shared_cache` on `otelcol.processor.transform`'s statement blocks now requires setting the `stability.level` flag to `experimental`; configuring it without that flag fails to load.
...
* **otelcol.processor.transform:** Add shared_cache ([#7164](https://github.com/grafana/alloy/issues/7164)) ([8c62dc7](https://github.com/grafana/alloy/commit/8c62dc71acef5093c27280586dc20c8909d33425))
...
* **otelcol:** Log a warning for deprecated Kafka and `k8sattributes` ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
...
* **otelcol:** Upgrade to OTel Collector v0.161.0 ([#7109](https://github.com/grafana/alloy/issues/7109)) ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
...
* **otel-supervisor:** Remove the now fully inert `reports_remote_config` ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
...
* **otelcol.receiver.kafka:** Reject configuring both ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
...
* **prometheus.remote_write:** Emit a conversion error instead of ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
...
* **deps:** Bump OpenTelemetry Collector to v0.161.0, Prometheus to ([95354a7](https://github.com/grafana/alloy/commit/95354a7cb7fb69a28b3ebc832b865312e7375c41))
