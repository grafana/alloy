...
This quickstart is for local installation in Windows and sending metrics to Grafana Cloud.
...
Within a few minutes of starting {{< param "PRODUCT_NAME" >}}, your Windows metrics should appear in Grafana Cloud.
