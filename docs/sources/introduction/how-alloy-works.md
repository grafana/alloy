...
You connect these components together to build exactly the pipeline you need.
This modular approach makes configurations easier to understand, test, and maintain.

## Programmable pipelines

{{< param "PRODUCT_NAME" >}} uses a rich, expression-based configuration language that lets you:
...
- Use built-in functions to transform and filter data
...
Share these custom components with your team or the community through the module system in {{< param "PRODUCT_NAME" >}}.
