...
| `collstats_colls`              | `string`   | List of comma separared databases.collections to get $collStats                                                                        | `""`    | no       |
| `indexstats_colls`             | `string`   | List of comma separared databases.collections to get $indexStats                                                                       | `""`    | no       |
...
| `profile_time_ts`              | `int`      | Set time for scrape slow queries. This interval must be synchronized with the Prometheus scrape interval                               | `true`  | no       |
