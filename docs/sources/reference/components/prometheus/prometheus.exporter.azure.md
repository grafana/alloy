...
| `regions`                     | `list(string)` | The list of regions for gathering metrics. Enables gathering metrics for all resources in the subscription. Can't be used if `resource_graph_query_filter` is set. |                                                                               | no       |
