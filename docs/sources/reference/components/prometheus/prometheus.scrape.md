...
| `scrape_created_timestamp_zero_ingestion` | `bool`                  | (Experimental) Whether to enable ingesting the created timestamp as a synthetic zero sample. See [created timestamps proposal][prom-proposal-ts] for details. | `false`                                                                                          | no       |
