...
To relabel labels inside pprof payloads, use [`pyroscope.profile.relabel`](../pyroscope.profile.relabel/), which is experimental and can increase CPU and memory usage.
{{< /admonition >}}
