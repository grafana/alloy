...
Personally Identifiable Information (PII) or undefined secret types could remain undetected. Additionally, the component may generate false positives. Don't rely solely on this component to redact sensitive information.
{{< /admonition >}}
