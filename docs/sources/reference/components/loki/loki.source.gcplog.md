...
To make use of the `pull` strategy, the GCP project must have been [configured](https://grafana.com/docs/loki/latest/send-data/promtail/) to forward its cloud resource logs onto a Pub/Sub topic for `loki.source.gcplog` to consume.
