...
| `endpoint`                             | `string`       | Endpoint where metric data is going to be sent to.                                                                                                                                                                                                    | `monitoring.googleapis.com`                              | no       |
...
| Name                                 | Type           | Description                                                                                                                                                                                         | Default                     | Required |
|--------------------------------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------|----------|
| `endpoint`                           | `string`       | Endpoint where trace data is going to be sent to.                                                                                                                                                   | `cloudtrace.googleapis.com` | no       |
...
| Name                          | Type           | Description                                                                                                                                                                                                     | Default                  | Required |
|-------------------------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|----------|
| `endpoint`                    | `string`       | Endpoint where log data is going to be sent to.                                                                                                                                                                 | `logging.googleapis.com` | no       |
