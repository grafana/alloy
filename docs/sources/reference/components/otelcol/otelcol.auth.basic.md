...
The following examples demonstrate how to perform basic authentication using either a username and password, the 
`client_auth` block, the `htpasswd` block, or a combination of these authentication methods.
...
of both an htpasswd file, and username and password
