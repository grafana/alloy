...
| `mimir_namespace_separator` | `string`            | Separator for Mimir namespace segments. Use a character that doesn’t require URL encoding when a reverse proxy drops encoded slashes. | `"/"`           | no       |
