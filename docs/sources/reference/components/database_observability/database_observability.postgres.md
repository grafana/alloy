...
Exempt samples containing wait events, finalized with idle in transaction states, or with observed CPU load always emit and do not advance the throttle window.
