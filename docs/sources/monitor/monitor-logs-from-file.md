...
To create a [dashboard](https://grafana.com/docs/grafana/latest/getting-started/build-first-dashboard/#create-a-dashboard) for visualizing metrics and logs, navigate to [`http://localhost:3000/dashboards`](http://localhost:3000/dashboards).
