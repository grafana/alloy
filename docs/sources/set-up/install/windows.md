...
- `ALLOY_OTEL_MODE`: Type `REG_SZ`. Set this value to `1` or `true` (case-insensitive) to run the {{< param "OTEL_ENGINE" >}} instead of the {{< param "DEFAULT_ENGINE" >}}. Refer to [Run with service installation][OTelEngine] for more information.
...
[OTelEngine]: ../../otel_engine/#run-with-service-installation
[Run]: ../../run/windows/
